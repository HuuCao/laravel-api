...
@section('content')
    ...
    <form action="{{route('post-add')}}" method="POST" id="product-form">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="product_name" id="" placeholder="Tên sản phẩm..." value="{{old('product_name')}}">
            <span style="color: red" class="error product_name_error"></span>
        </div>
        <div class="mb-3">
            <label for="">Giá sản phẩm</label>
            <input type="text" class="form-control" name="product_price" id="" placeholder="Giá sản phẩm..." value="{{old('product_price')}}">
